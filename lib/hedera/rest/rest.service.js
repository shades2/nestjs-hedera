...
let RestService = class RestService {
    constructor(mirrorNode, httpService) {
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    let response = yield this.httpService
                        .get(`${this.mirrorNode.url}/api/v1/${endpoint}`, { headers: { 'authorization': this.mirrorNode.apiKey } }).toPromise();
...
RestService = __decorate([
    ...
    __param(0, (0, common_1.Inject)('mirrorNode')),

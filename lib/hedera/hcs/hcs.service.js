...
let HcsService = class HcsService {
     ...
     */
    getMessages(topicId, callbackSuccess, start, end, limit, callbackError, isPublicMirror) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let subscription = transaction.subscribe(client, (message, error) => callbackError(message, error), (message) => callbackSuccess(message));

...
let AccountsService = class AccountsService {
   ...
   */
     ...
     */
    updateAccount(accountId, signKey, newKey, memo, maxAutomaticTokenAssociations, isReceiverSignatureRequired) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const client = this.clientService.getClient();
   ...
   */
    createAccount(balance, keysLength, publicKeys, keysThreshold, maxAutomaticTokenAssociations, isReceiverSignatureRequired) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const client = this.clientService.getClient();

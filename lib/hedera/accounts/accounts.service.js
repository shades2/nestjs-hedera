...
let AccountsService = class AccountsService {
   ...
   */
     ...
     */
    updateAccount(accountId, signKey, newKey, memo, maxAutomaticTokenAssociations, isReceiverSignatureRequired, isOfflineTransaction) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const client = this.clientService.getClient();
   ...
   */
    createAccount(balance, keysLength, publicKeys, keysThreshold, maxAutomaticTokenAssociations, isReceiverSignatureRequired, isOfflineTransaction) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const client = this.clientService.getClient();
                    ...
                    if (balance) {
                        transaction.setInitialBalance(new sdk_1.Hbar(balance.toFixed(8)));
                    }
                    if (maxAutomaticTokenAssociations) {
                        transaction.setMaxAutomaticTokenAssociations(maxAutomaticTokenAssociations);
                    }
            ...
            try {
                ...
                if (tokenId) {
                    balance = {
                        tokens: [{
                                tokenId: tokenId,
                                balance: ((_a = response.tokens) === null || _a === void 0 ? void 0 : _a._map.get(tokenId)) ? new decimal_js_1.Decimal((_b = response.tokens._map.get(tokenId)) === null || _b === void 0 ? void 0 : _b.toString()) : 0,
                                decimals: ((_c = response.tokens) === null || _c === void 0 ? void 0 : _c._map.get(tokenId)) ? new decimal_js_1.Decimal((_d = response.tokenDecimals) === null || _d === void 0 ? void 0 : _d._map.get(tokenId)) : 0
                            }],
                    ...
                    (_e = response.tokens) === null || _e === void 0 ? void 0 : _e._map.forEach((value, tokenId) => {
                        ...
                        tokens.push({
                            tokenId: tokenId,
                            balance: ((_a = response.tokens) === null || _a === void 0 ? void 0 : _a._map.get(tokenId)) ? new decimal_js_1.Decimal((_b = response.tokens._map.get(tokenId)) === null || _b === void 0 ? void 0 : _b.toString()) : new decimal_js_1.Decimal(0),
                            decimals: ((_c = response.tokens) === null || _c === void 0 ? void 0 : _c._map.get(tokenId)) ? new decimal_js_1.Decimal((_d = response.tokenDecimals) === null || _d === void 0 ? void 0 : _d._map.get(tokenId)) : new decimal_js_1.Decimal(0)
                        });
                    });
                    balance = {
                        tokens: tokens,

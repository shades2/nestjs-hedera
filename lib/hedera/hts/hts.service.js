            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const transaction = new sdk_1.TransferTransaction()
                        .addHbarTransfer(from, new sdk_1.Hbar(-amount.toFixed(8)))
                        .addHbarTransfer(to, new sdk_1.Hbar(amount.toFixed(8)));
                    if (memo) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if (hbarAmount) {
                        transaction
                            .addHbarTransfer(from, new sdk_1.Hbar(-hbarAmount.toFixed(8)))
                            .addHbarTransfer(to, new sdk_1.Hbar(hbarAmount.toFixed(8)));
                    }
